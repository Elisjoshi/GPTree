  ...
  return (
    <>
      <div
        ...
        className="w-24 h-16 flex items-center justify-center bg-white border-2 border-gray-300 rounded-md shadow-md hover:border-blue-500 transition-colors text-center px-2 text-sm cursor-pointer"
      >
        {nodeData.question}
      </div>
